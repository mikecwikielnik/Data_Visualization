...
# Instead, you can use the title for the data set in the metadata part of the JSON file. Pull this value, assign it to a variable,
# and use this for the title of the map when you’re defining my_layout.

# Matthes, Eric. Python Crash Course, 2nd Edition (p. 357). No Starch Press. Kindle Edition. 
