...
for submission_id in submission_ids[:30]:
    ...
    submission_dict = {
        ...
        'hn_link': f"http://news.ycombinator.com/item?item?id={submission_id}",
        'comments': response_dict['descendants'],
    }
    submission_dicts.append(submission_dict)

submmission_dicts = sorted(submission_dicts, key=itemgetter('comments'),
                           reverse=True)

for submission_dict in submmission_dicts:
